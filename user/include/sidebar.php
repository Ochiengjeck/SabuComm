...
?>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="register-inquiry.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Lodge an Inquiry</span></a>
					</li>
					<li class="nav-item">
					    <a href="inquiry-history.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">History</span></a>
					</li>
					<li class="nav-item">
						<a href="inquiry-faqs.php" class="nav-link"><span class="pcoded-micon"><i class="feather icon-help-circle"></i></span><span class="pcoded-mtext">F.A.Qs</span></a>
					</li>
