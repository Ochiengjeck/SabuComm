...
?>	
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-menu-caption">
						<label>User Inquiries</label>
					</li>


					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Manage Inquiries</span></a>
						<ul class="pcoded-submenu">
							<li>
	<a href="all-inquiry.php">All Inquiries</a></li>
							<li>
	<a href="notprocess-inquiry.php">Not Process Yet</a></li>
							<li>
								<a href="inprocess-inquiry.php">In Process</a></li>
							
							<li><a href="closed-inquiry.php">processed Inquiries</a></li>
					...
					<li class="nav-item">
					    <a href="between-date-inquiryreport.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">Inquiries Report</span></a>
					</li>
					<li class="nav-item pcoded-menu-caption">
						<label>Search</label>
					</li>
					...
					<li class="nav-item">
					    <a href="inquiry-search.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-search"></i></span><span class="pcoded-mtext">Search Inquiry</span></a>
					</li>
