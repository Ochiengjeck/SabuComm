<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
				...
				<div class="m-header">
					...
					<a href="dashboard.php" class="b-brand">
						...
						<strong>SABU Inquiry Management</strong>
					</a>
						...
						<li>
							<div class="dropdown">
								<a class="dropdown-toggle" href="#" data-toggle="dropdown">
									...
									<?php
$rt = mysqli_query($con,"select tblinquiries.*,users.fullName as name from tblinquiries join users on users.id=tblinquiries.userId where tblinquiries.status is null");
...
?>
											<div class="media">
												...
												<div class="media-body">
													...
													<p>Inquiry No.<a href="inquiry-details.php?cid=<?php echo htmlentities($row['inquiryNumber']);?>"><?php echo htmlentities($row['inquiryNumber']);?> at <small><?php echo htmlentities($row['regDate']);?></small> </a></p>
												</div>
											</div>
											<br><?php $cnt=$cnt+1; } ?>
										</li>
