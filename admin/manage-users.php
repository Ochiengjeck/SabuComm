...
$query1=mysqli_query($con,"delete from tblinquiries where userId='$userid'");
...
<a href="manage-users.php?uid=<?php echo htmlentities($row['id']);?>&&action=del" title="Delete" onClick="return confirm('All inquiries belongs to user will also delete.')" class="btn btn-danger">Delete</a>

<a href="user-inquiries.php?uid=<?php echo htmlentities($row['id']);?>&&uname=<?php echo htmlentities($row['fullName']);?>" title="View User inquiries" class="btn btn-info  btn-xs">inquiries</a>
                                        </td>
