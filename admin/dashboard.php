...
<head>
    <title>SaBU Admin || Dashboard</title>
            ...
            <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card widget-purple-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php $query5=mysqli_query($con,"select inquiryNumber from tblinquiries where status='closed'");
$closedcom=mysqli_num_rows($query5);
?>
                            <h4><?php echo $closedcom;?></h4>
                            <a href="closed-inquiry.php"><h6>Closed Inquiries</h6></a>
                        </div>
                    </div>
                </div>
              ...
              <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card widget-purple-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php $query5=mysqli_query($con,"select inquiryNumber from tblinquiries");
$totcom=mysqli_num_rows($query5);
?>
                            <h4><?php echo $totcom;?></h4>
                            <a href="all-inquiry.php"><h6>Total Inquiries</h6></a>
                        </div>
                    </div>
                </div>
                <!-- widget-success-card end -->
              ...
              <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card bg-danger">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                          <?php $query5=mysqli_query($con,"select inquiryNumber from tblinquiries where status is null");
$newcom=mysqli_num_rows($query5);
?>
                            <h4><?php echo $newcom;?></h4>
                            <a href="notprocess-inquiry.php"><h6>Pending Inquiries</h6></a>
                        </div>
                    </div>
                </div>
                <!-- widget-success-card end -->
              ...
              <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card bg-warning">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php $query5=mysqli_query($con,"select inquiryNumber from tblinquiries where status='in process'");
$inprocesscom=mysqli_num_rows($query5);
?>
                            <h4><?php echo $inprocesscom;?></h4>
                            <a href="inprocess-inquiry.php"><h6>Inprocess Inquiries</h6></a>
                        </div>
                    </div>
                </div>
