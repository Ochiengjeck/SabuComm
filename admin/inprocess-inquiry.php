...
<head>
    <title>CMS|| Inprocess Inquiries</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Inprocess Inquiries</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="inprocess-inquiry.php">Inprocess Inquiries</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5>View Inprocess Inquiries</h5>
                        <hr>
