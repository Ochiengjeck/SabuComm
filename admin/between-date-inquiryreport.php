...
<head>
    <title>CMS|| Between Dates Inquiry Report</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Between Dates Inquiry Report</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="between-date-inquiryreport.php">Between Dates Inquiry Report</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5>Between Dates Inquiry Report</h5>
                        <hr>
                       <div class="card-body">
<form  method="post">                                
<div class="row">
...
$query=mysqli_query($con,"select tblinquiries.*,users.fullName as name from tblinquiries join users on users.id=tblinquiries.userId where tblinquiries.regDate between '$fdate' and '$tdate'");
$cnt=1;
